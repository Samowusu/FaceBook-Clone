...
import classes from "./StatusUpdater.module.css";
...
function StatusUpdater() {
	...
	return (
		<div className={classes.statusUpdater}>
			...
			<div className={classes["statusUpdater-bottom"]}>
				<ul>
					<li>
